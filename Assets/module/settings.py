...
# BACKDROP MARGINS
# Căn giữa: tổng chiều rộng (panel + backdrop) trong window
SIDE_PANEL_WIDTH = 220
# Tính toán để căn giữa cả khung + game
TOTAL_GAME_WIDTH = SIDE_PANEL_WIDTH + BACKDROP_WIDTH
MARGIN_LEFT_OFFSET = (SCREEN_WIDTH - TOTAL_GAME_WIDTH) // 2
MARGIN_BACKDROP_X = MARGIN_LEFT_OFFSET + SIDE_PANEL_WIDTH
