...
def is_linked(map_data: list, direction: tuple, facing_direction: str) -> bool: #check if have walls on the way
...
def generate_next_zombie_positions(map_data: list, current_zombie_positions: list, current_player_position: tuple) -> list:
    ...
    def generate_type_0(map_data: list, current_zombie_position: tuple, current_player_position: tuple) -> tuple:
        """
    ...
    def generate_type_1(map_data: list, current_zombie_position: tuple, current_player_position: tuple) -> tuple:
        """
    ...
    def generate_type_2(map_data: list, current_zombie_position: tuple, current_player_position: tuple) -> tuple:
        """
    ...
    def generate_type_3(map_data: list, current_zombie_position: tuple, current_player_position: tuple) -> tuple:
        """
...
def Shortest_Path(map_data: list, zombie_positions: list, start: tuple, goal: tuple) -> list: #include zombie position
    ...
    while path:
        ...
        for zombie_info in zombie_list:
            ...
            if player_path[-1] == zombie_position:
                player_died = True
                break
